...
# 1.) ECB: "Electronic Code Book" -> we use AES on every 64 bits long plaintext block
#           these blocks are independnt of each other so we use AES seperately on every block
...
#
#       THE PADDING PROBLEM
#           AES algorithm uses 128 bits lopng inputs: what if the plaintext is not divisible by 128?
